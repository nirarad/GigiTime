...
const defaultSongs: Song[] = [
  { id: 1, name: "Eye in the sky", tempo: 122, editing: false },
  { id: 2, name: "Sharp dressed man - Nickelback", tempo: 127, editing: false },
  { id: 3, name: "Don't bring me down", tempo: 119, editing: false },
  { id: 4, name: "Ran so far away", tempo: 146, editing: false },
  { id: 5, name: "Call me", tempo: 139, editing: false },
  { id: 6, name: "Summer of 69", tempo: 128, editing: false },
  { id: 7, name: "Hold the line", tempo: 102, editing: false },
  { id: 8, name: "Shout", tempo: 94, editing: false },
  { id: 9, name: "Beat it", tempo: 139, editing: false },
  { id: 10, name: "What's a woman", tempo: 100, editing: false },
  { id: 11, name: "Every breath you take", tempo: 117, editing: false },
  { id: 12, name: "Pretty woman", tempo: 126, editing: false },
  { id: 13, name: "Wiskey in the jar", tempo: 129, editing: false },
  { id: 14, name: "I want to break free", tempo: 119, editing: false },
  { id: 15, name: "Behind blue eyes", tempo: 124, editing: false },
  { id: 16, name: "Sweet dreams", tempo: 125, editing: false },
  { id: 17, name: "The best", tempo: 104, editing: false },
  { id: 18, name: "Juniors wailing – Status Quo", tempo: 135, editing: false },
